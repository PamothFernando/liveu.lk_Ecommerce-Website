...
Route::get('/solutions/cctv-solutions', [HomeController::class, 'cctv'])->name('home.solutions.cctv');
Route::get('/solutions/time-attendance', [HomeController::class, 'timeattendance'])->name('home.solutions.timeattendance');
Route::get('/solutions/ip-pbx', [HomeController::class, 'ippbx'])->name('home.solutions.ippbx');
Route::get('/solutions/library-system', [HomeController::class, 'librarysystems'])->name('home.solutions.librarysystems');
Route::get('/solutions/fiber-optic-solutions', [HomeController::class, 'fiberOptic'])->name('home.solutions.fiberOptic');
Route::get('/solutions/parking-management', [HomeController::class, 'parkingManagement'])->name('home.solutions.parkingManagement');
Route::get('/solutions/fire', [HomeController::class, 'firealarm'])->name('home.solutions.firealarm');
Route::get('/solutions/hotel-management', [HomeController::class, 'hotelmanagement'])->name('home.solutions.hotelmanagement');
Route::get('/solutions/guard-tour-systems', [HomeController::class, 'guardtour'])->name('home.solutions.guardtour');
Route::get('/solutions/software-solutions', [HomeController::class, 'softwaresolutions'])->name('home.solutions.softwaresolutions');


// Show the dealer registration form
Route::get('/registration/dealer-registration', [DealerController::class, 'dealer'])->name('dealer.registration');

// Handle form submission
Route::post('/registration/dealer-registration', [DealerController::class, 'storeDealer'])->name('dealer.store');


// Show the dealer registration form
Route::get('/registration/distributor-registration', [DistributorController::class, 'distributor'])->name('distributor.registration');

// Handle form submission
Route::post('/registration/distributor-registration', [DistributorController::class, 'storeDistributor'])->name('distributor.store');
