                            ...
                            <ul class="d-flex align-itmes-center justify-content-end">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <div class="container" style="width: 690px; height:200px; margin-top: 0px; ">

                                            <div class="row row-cols-3" style="height: 45px; width: auto; margin-top: 0px;">
                                                <div class="col" style="background-color: transparent; width: 230px;">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('home.solutions.cctv') }}"><p><img src="/public/assets/images/solutions/solution1.png" alt="cctvsolution" style="height:30px; width:30px;">  {{ localize('CCTV Solution') }}</p></a>
                                                    </li>
                                                </div>
                                                <div class="col" style="background-color: transparent; width: 230px;">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('home.solutions.timeattendance') }}"><p><img src="/public/assets/images/solutions/solution2.png" alt="cctvsolution" style="height:30px; width:30px;">  {{ localize('TIME Attendance') }}</p></a>
                                                    </li>
                                                </div>
                                                <div class="col" style="background-color: transparent; width: 230px;">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('home.solutions.ippbx') }}"><p><img src="/public/assets/images/solutions/solution3.png" alt="cctvsolution" style="height:30px; width:30px;">  {{ localize('IP PBX Solutions') }}</p></a>
                                                    </li>
                                                </div>
                                            </div>


                                            <div class="row row-cols-3"style="height: 45px; width: auto;margin-top:5px;">
                                                <div class="col" style="background-color: transparent; width: 230px;">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('home.solutions.librarysystems') }}"><p><img src="/public/assets/images/solutions/solution4.png" alt="cctvsolution" style="height:30px; width:30px;">  {{ localize('RFID Library Technologies') }}</p></a>
                                                    </li>
                                                </div>
                                                <div class="col" style="background-color: transparent; width: 230px;">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('home.solutions.fiberOptic') }}"><p><img src="/public/assets/images/solutions/solution5.png" alt="cctvsolution" style="height:30px; width:30px;">  {{ localize('FIBER OPTIC Solutions') }}</p></a>
                                                    </li>
                                                </div>
                                                <div class="col" style="background-color: transparent; width: 230px;">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('home.solutions.parkingManagement') }}"><p><img src="/public/assets/images/solutions/solution6.png" alt="cctvsolution" style="height:30px; width:30px;">  {{ localize('Parking Management') }}</p></a>
                                                    </li>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row row-cols-3" style="height: 45px;width: auto;margin-top:5px;">
                                                <div class="col" style="background-color: transparent; width: 230px;">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('home.solutions.firealarm') }}"><p><img src="/public/assets/images/solutions/solution7.png" alt="cctvsolution" style="height:30px; width:30px;">  {{ localize('Fire Alarm Systems') }}</p></a>
                                                    </li>
                                                </div>
                                                <div class="col" style="background-color: transparent; width: 230px;">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('home.solutions.hotelmanagement') }}"><p><img src="/public/assets/images/solutions/solution8.png" alt="cctvsolution" style="height:30px; width:30px;">  {{ localize('Hotel Management') }}</p></a>
                                                    </li>
                                                </div>
                                                <div class="col" style="background-color: transparent; width: 230px;">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('home.solutions.guardtour') }}"><p><img src="/public/assets/images/solutions/solution9.png" alt="cctvsolution" style="height:30px; width:30px;">  {{ localize('Guard Tour Systems') }}</p></a>
                                                    </li>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row row-cols-3" style="height: 45px;width: auto; margin-top:5px;">
                                                <div class="col" style="background-color: transparent; width: 230px;">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('home.solutions.softwaresolutions') }}"><p><img src="/public/assets/images/solutions/solution10.png" alt="cctvsolution" style="height:30px; width:30px;">  {{ localize('Software Solutions') }}</p></a>
                                                    </li>
                                                </div>
                                                <div class="col">
                                                </div>
