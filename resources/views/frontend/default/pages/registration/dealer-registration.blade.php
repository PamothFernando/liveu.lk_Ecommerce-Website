...
<title>Live U Dealer Registration</title>
<style>
  body {
    margin: 0;
    height: 100vh;
...
<div class="container">
  ...
  <div class="right-section">
    ...
    <form id="dealerForm" method="POST" action="{{ route('dealer.store') }}">
        @csrf

        <!-- ✅ Honeypot -->
        <input type="text" name="dealer_extra" style="display:none">

        <input type="text" name="dealerfullname" placeholder="First & Last Name Ex: Shenali Senevirathene" value="{{ old('dealerfullname') }}" required />
        <input type="text" name="dealerphone" placeholder="Phone Number Ex: 0710333356" value="{{ old('dealerphone') }}" required />
        <input type="text" name="dealercompany" placeholder="Company Name" value="{{ old('dealercompany') }}" required />
        <input type="text" name="dealeraddress" placeholder="Company Address" value="{{ old('dealeraddress') }}" required />
        <input type="email" name="dealeremail" placeholder="Email Address" value="{{ old('dealeremail') }}" required />
    ...
    <div class="footer">
      Live U (PVT) LTD Dealer Registration | Support Center: 0117 780 000<br>
